  ...
  return (
    <div className="w-full min-h-screen text-pink-400 px-4 sm:px-6 py-6 sm:py-8" style={{ fontFamily: "'Dm Serif Display', serif" }}>
      ...
      <div className="max-w-4xl mx-auto text-center mb-8 sm:mb-12">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-yellow-400 mb-4 sm:mb-6">Epilogue 4:<br></br>Sole Survivor</h1>
        <h2 
          ...
          <div className="space-y-8">
            <div className="bg-black/20 rounded-lg p-6 border-4 border-yellow-400/50">
              <div className="space-y-6">
                ...
                >
                  Only one among your party has survived the Heart of the Woods. They emerge alone, forever changed by what they witnessed in the darkness.
                </p>
                ...
                <p 
                  ...
                  className="text-yellow-250 text-lg sm:text-xl leading-relaxed text-center"
                >
                  The detailed epilogue content for the sole survivor will be added here...
                </p>
              </div>
            </div>
