          ...
          <div className="space-y-8">
            <div className="bg-black/20 rounded-lg p-6 border-4 border-yellow-400/50">
              <div className="space-y-6">
                ...
                >
                  The Woods demanded a heavy price. Some of your party have fallen to the darkness, while others emerged changed but alive.
                </p>
                ...
                <p 
                  ...
                  className="text-yellow-250 text-lg sm:text-xl leading-relaxed text-center"
                >
                  The detailed epilogue content for this mixed outcome will be added here...
                </p>
              </div>
            </div>
